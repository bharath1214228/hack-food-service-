...
(function ($, drupalSettings) {
  ...
  if (!drupalSettings.gfs_instagram || !drupalSettings.gfs_instagram.block_id) {
    return;
  }

  $(document).ready(function () {
    drupalSettings.gfs_instagram.block_id.forEach(function (block_id) {
      $.get( drupalSettings.path.pathPrefix  + "gfs_instagram/ajax/" + block_id, function( commands ) {
