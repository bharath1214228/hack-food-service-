...
!function($){function nextSlide(slider){slider.find(".testimonial-slider__item--active").removeClass("testimonial-slider__item--active").addClass("testimonial-slider__item--old-active"),slider.find(".testimonial-slider__item__selector--active").removeClass("testimonial-slider__item__selector--active").addClass("testimonial-slider__item__selector--old-active"),slider.find(".testimonial-slider__item--old-active").is(":last-child")?(slider.find(".testimonial-slider__item").first().addClass("testimonial-slider__item--active"),slider.find(".testimonial-slider__item__selector").first().addClass("testimonial-slider__item__selector--active")):(slider.find(".testimonial-slider__item--old-active").next().addClass("testimonial-slider__item--active"),slider.find(".testimonial-slider__item__selector--old-active").next().addClass("testimonial-slider__item__selector--active")),slider.find(".testimonial-slider__item--old-active").removeClass("testimonial-slider__item--old-active"),slider.find(".testimonial-slider__item__selector--old-active").removeClass("testimonial-slider__item__selector--old-active")}$(window).resize(function(){$(".testimonial-slider").each(function(){var max_item_height=0,slideshow=$(this);if($(this).find(".testimonial-slider__item").each(function(){parseInt($(this).height())>parseInt(max_item_height)&&(max_item_height=parseInt($(this).height())+120)}),$(window).width()<=768){var slideshow_height=parseInt(slideshow.find(".col-lg-7").height())+150+parseInt(max_item_height);slideshow.css({height:parseInt(slideshow_height)+"px"}),slideshow.find(".col-lg-5").css({height:parseInt(max_item_height)+30+"px"})}if($(window).width()>768){var slideshow_height=150+parseInt(max_item_height);slideshow.css({height:parseInt(slideshow_height)+"px"}),slideshow.find(".col-lg-5").css({height:parseInt(max_item_height)+30+"px"})}})}),$(".testimonial-slider").each(function(){var max_item_height=0,slideshow=$(this);$(this).find(".testimonial-slider__item").each(function(){parseInt($(this).height())>parseInt(max_item_height)&&(max_item_height=parseInt($(this).height())+40)});var slideshow_height=parseInt(slideshow.parent().height())+parseInt(max_item_height);$(this).css({height:parseInt(slideshow_height)+"px"}),$(this).find(".col-lg-5").css({height:parseInt(slideshow_height)-parseInt(slideshow.find(".col-lg-7").height())-120+"px"}),$(this).find(".testimonial-slider__item:first-child").addClass("testimonial-slider__item--active"),$(this).find(".testimonial-slider__item:first-child .testimonial-slider__item__selector").addClass("testimonial-slider__item__selector--active"),$(this).find(".testimonial-slider__item__selector").appendTo($(this).find(".testimonial-slider__pager")),$(this).find(".testimonial-slider__item__selector").on("click",function(){$(this).parent().parent().find(".testimonial-slider__item").removeClass("testimonial-slider__item--active"),$(this).parent().parent().find(".testimonial-slider__item:eq("+$(this).index()+")").addClass("testimonial-slider__item--active"),$(this).parent().find(".testimonial-slider__item__selector").removeClass("testimonial-slider__item__selector--active"),$(this).addClass("testimonial-slider__item__selector--active")});var interval=null;interval=window.setInterval(function(){nextSlide(slideshow)},8e3),$(this).hover(function(){window.clearInterval(interval)},function(){interval=window.setInterval(function(){nextSlide(slideshow)},8e3)}),$(this).hover(function(){$(this).addClass("testimonial-slider--hovered")},function(){$(this).removeClass("testimonial-slider--hovered")})})}(jQuery);;
