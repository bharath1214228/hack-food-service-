...
(function ($) {
  ...
  window.gfs_modal = new VanillaModal.default({
    'modal': '.custom-modal',
    'page': 'html',
    'onOpen': function () {
...
(function ($) {
  ...
  $('.custom-modal').addClass('custom-modal--multi-cta');
...
(function ($) {
  ...
  Drupal.behaviors.GFSCard = {
    attach: function(context, settings) {

      // Bind clicking to the card on AJAX load
      $('.gfs-card:not(.gfs-card--popular)').find('.gfs-card__wrapper').once('gfs-card-clicker').each(function() {
        if($(this).find('.gfs-card__title a').attr('href') !== undefined) {
          $(this).parent().removeClass('gfs-card--without-link');
          $(this).parent().addClass('gfs-card--with-link');
          $(this).on('click', function(e) {
            if($(this).find('.gfs-card__title a').attr('data-modal-open') !== undefined) {
              window.gfs_modal.open($(this).find('.gfs-card__title a').attr('href'));
            } else {
              window.location = $(this).find('.gfs-card__title a').attr('href');
            }
            e.preventDefault();
          });
        } else {
          $(this).parent().removeClass('gfs-card--with-link');
          $(this).parent().addClass('gfs-card--without-link');
        }
      });

      // Bind clicking minimal related cards on AJAX load
      $('.gfs-card--related .gfs-card__wrapper').once('gfs-card-related-clicker').each(function() {
        if($(this).find('.gfs-card__title a').attr('href') !== undefined) {
          $(this).parent().removeClass('gfs-card--without-link');
          $(this).parent().addClass('gfs-card--with-link');
          $(this).on('click', function(e) {
