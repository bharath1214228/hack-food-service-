...
var gfs=void 0===gfs?{}:gfs;console.log("%c🍔%c🍕%c🧀%c🌮%c🍇%c🌭%c🍏","font-size: 60px;color:brown","font-size:60px;color:red","font-size:60px;color:#cccc00","font-size:60px;color:orange","font-size:60px;color:purple","font-size:60px;color:#E68A1D","font-size:60px;color:green;");;
var $=jQuery;;
...
;
!function($){$(".language-switcher.collapsed a.is-active").unbind("click"),$(".language-switcher.collapsed a.is-active").bind("click",function(e){e.preventDefault()}),$(".language-switcher.collapsed").bind("click",function(e){$(this).removeClass("collapsed"),$(this).unbind("click"),e.preventDefault(),$(".language-switcher li:not(.is-active)").toggle()})}(jQuery);;
!function($){$(".subnav--mobile__cross").hide(),$(".subnav--mobile__wrapper").click(function(){$(".subnav").slideToggle(),0==$(".subnav--mobile__wrapper.close-menu").length?($(".subnav--mobile__hamburger").hide(),$(".subnav--mobile__cross").show(),$(".subnav--mobile__wrapper").addClass("close-menu")):($(".subnav--mobile__cross").hide(),$(".subnav--mobile__hamburger").show(),$(".subnav--mobile__wrapper").removeClass("close-menu"))})}(jQuery);;
!function($){function mobileMenu(){$(window).width()>mobile_menu_pixel_breakpoint?(search_box_element.appendTo(header_top_second),header_cta_menu.appendTo(header_top_second),main_menu.appendTo(header_bottom),secondary_menu.appendTo(header_bottom),$(".sign-in-button--mobile").remove(),$(header_menu_expanding_selector_item).off("click"),$(header_menu_expanding_selector_item).on("click",function(event){var menu_item=$(this);event.stopPropagation(),menu_item.hasClass("menu-item--top-level-clicked")||"none"!=menu_item.find("ul").css("display")||(menu_item.addClass("menu-item--top-level-clicked"),menu_item.find("ul").css({display:"block"}))}),$(window).on("click",function(){$(window).width()>mobile_menu_pixel_breakpoint&&($(header_menu_expanding_selector_item).removeClass("menu-item--top-level-clicked"),$(header_menu_expanding_selector_item).find("ul").css({display:"none"}))})):($(header_menu_expanding_selector_item).off("click"),search_box_element.prependTo(mobile_header_wrapper),main_menu.appendTo(mobile_header_container),secondary_menu.appendTo(mobile_header_container),header_cta_menu.appendTo(mobile_header_container),0==header_top_second.find(".sign-in-button").length&&(header_cta_menu.find(".sign-in-button").clone().appendTo(header_top_second),header_top_second.find(".sign-in-button").addClass("sign-in-button--mobile")),$(header_menu_expanding_selector).off("click"),$(header_menu_expanding_selector).on("click",function(event){if($(this).parent().hasClass("show-submenu"))var parent_is_open=!0;else var parent_is_open=!1;$(header_menu_expanding_selector).parent().removeClass("show-submenu"),parent_is_open?$(this).parent().removeClass("show-submenu"):$(this).parent().addClass("show-submenu"),event.stopPropagation()}))}var mobile_menu_pixel_breakpoint=768,mobile_header_wrapper=$(".site-header__mobile-wrapper"),mobile_header_container=$(".container--header--mobile"),header_top_second=$(".site-header__top__second"),header_bottom=$(".site-header__bottom"),header_menu_expanding_selector=".site-header nav.menu > ul > li > span",header_menu_expanding_selector_item=".site-header nav.menu > ul > li.menu-item--expanded",search_box_element=$(".search-box"),secondary_menu=$(".site-header__secondary-menu"),main_menu=$(".site-header__menu"),header_cta_menu=$(".site-header__cta-menu");$("#toggle-nav").click(function(){$("body").toggleClass("show-nav"),$(header_menu_expanding_selector).parent().removeClass("show-submenu")}),window.width,mobileMenu(),$(window).resize(function(){"text"!==$(document.activeElement).prop("type")&&mobileMenu()})}(jQuery);;
!function($){$(document).ready(function(){$("nav.menu--main").setup_navigation()});var keyCodeMap={48:"0",49:"1",50:"2",51:"3",52:"4",53:"5",54:"6",55:"7",56:"8",57:"9",59:";",65:"a",66:"b",67:"c",68:"d",69:"e",70:"f",71:"g",72:"h",73:"i",74:"j",75:"k",76:"l",77:"m",78:"n",79:"o",80:"p",81:"q",82:"r",83:"s",84:"t",85:"u",86:"v",87:"w",88:"x",89:"y",90:"z",96:"0",97:"1",98:"2",99:"3",100:"4",101:"5",102:"6",103:"7",104:"8",105:"9"};$.fn.setup_navigation=function(settings){settings=jQuery.extend({menuHoverClass:"show-menu"},settings),$(this).attr("role","menubar").find("li").attr("role","menuitem");var top_level_links=$(this).find("ul > li > span");$(top_level_links).next("ul").attr("data-test","true").attr({"aria-hidden":"true",role:"menu"}).find("a").attr("tabIndex",-1),$(top_level_links).each(function(){$(this).next("ul").length>0&&$(this).parent("li").attr("aria-haspopup","true")}),$(top_level_links).hover(function(){$(this).closest("ul").attr("aria-hidden","false").find("."+settings.menuHoverClass).attr("aria-hidden","true").removeClass(settings.menuHoverClass).find("a").attr("tabIndex",-1),$(this).next("ul").attr("aria-hidden","false").addClass(settings.menuHoverClass).find("a").attr("tabIndex",0)}),$(top_level_links).on("mouseout",function(){$("."+settings.menuHoverClass).attr("aria-hidden","true").removeClass(settings.menuHoverClass).find("a").attr("tabIndex",-1)}),$(top_level_links).focus(function(){$(this).closest("ul").find("."+settings.menuHoverClass).attr("aria-hidden","true").removeClass(settings.menuHoverClass).find("a").attr("tabIndex",-1),$(this).next("ul").attr("aria-hidden","false").addClass(settings.menuHoverClass).find("a").attr("tabIndex",0)}),$(top_level_links).keydown(function(e){37==e.keyCode?(e.preventDefault(),0==$(this).parent("li").prev("li").length?$(this).parents("ul").find("> li").last().find("a").first().focus():$(this).parent("li").prev("li").find("a").first().focus()):38==e.keyCode?(e.preventDefault(),$(this).parent("li").find("ul").length>0&&$(this).parent("li").find("ul").attr("aria-hidden","false").addClass(settings.menuHoverClass).find("a").attr("tabIndex",0).last().focus()):39==e.keyCode?(e.preventDefault(),0==$(this).parent("li").next("li").length?$(this).parents("ul").find("> li").first().find("a").first().focus():$(this).parent("li").next("li").find("a").first().focus()):40==e.keyCode?(e.preventDefault(),$(this).parent("li").find("ul").length>0&&$(this).parent("li").find("ul").attr("aria-hidden","false").addClass(settings.menuHoverClass).find("a").attr("tabIndex",0).first().focus()):13==e.keyCode||32==e.keyCode?(e.preventDefault(),$(this).parent("li").find("ul[aria-hidden=true]").attr("aria-hidden","false").addClass(settings.menuHoverClass).find("a").attr("tabIndex",0).first().focus()):27==e.keyCode?(e.preventDefault(),$("."+settings.menuHoverClass).attr("aria-hidden","true").removeClass(settings.menuHoverClass).find("a").attr("tabIndex",-1)):$(this).parent("li").find("ul[aria-hidden=false] a").each(function(){if($(this).text().substring(0,1).toLowerCase()==keyCodeMap[e.keyCode])return $(this).focus(),!1})});var links=$(top_level_links).parent("li").find("ul").find("a");$(links).keydown(function(e){if(38==e.keyCode)e.preventDefault(),0==$(this).parent("li").prev("li").length?$(this).parents("ul").parents("li").find("a").first().focus():$(this).parent("li").prev("li").find("a").first().focus();else if(40==e.keyCode)e.preventDefault(),0==$(this).parent("li").next("li").length?$(this).parents("ul").parents("li").find("a").first().focus():$(this).parent("li").next("li").find("a").first().focus();else if(27==e.keyCode||37==e.keyCode)e.preventDefault(),$(this).parents("ul").first().prev("a").focus().parents("ul").first().find("."+settings.menuHoverClass).attr("aria-hidden","true").removeClass(settings.menuHoverClass).find("a").attr("tabIndex",-1);else if(32==e.keyCode)e.preventDefault(),window.location=$(this).attr("href");else{var found=!1;$(this).parent("li").nextAll("li").find("a").each(function(){if($(this).text().substring(0,1).toLowerCase()==keyCodeMap[e.keyCode])return $(this).focus(),found=!0,!1}),found||$(this).parent("li").prevAll("li").find("a").each(function(){if($(this).text().substring(0,1).toLowerCase()==keyCodeMap[e.keyCode])return $(this).focus(),!1})}}),$(this).find("a").last().keydown(function(e){9==e.keyCode&&$("."+settings.menuHoverClass).attr("aria-hidden","true").removeClass(settings.menuHoverClass).find("a").attr("tabIndex",-1)}),$(document).click(function(){$("."+settings.menuHoverClass).attr("aria-hidden","true").removeClass(settings.menuHoverClass).find("a").attr("tabIndex",-1)}),$(this).click(function(e){e.stopPropagation()})}}(jQuery);;
...
[].forEach.call(
    document.querySelectorAll('.form-text, .form-email, .form-textarea'),
    (el) => {
        el.onblur = () => {
            setActive(el, false)
        }
...
setInterval(() => {
    const errMsg = document.querySelector('.messages--error')
    if (errMsg) {
        [].forEach.call(
            document.querySelectorAll('.form-text, .form-email, .form-textarea'),
            (el) => {
...
;
!function($){var url=location.href.replace(/\/$/,"");if(location.hash){var hash=url.split("#");$('.nav-tabs--gfs a[href="#'+hash[1]+'"]').tab("show"),url=location.href.replace(/\/#/,"#"),history.replaceState(null,null,url)}$('.nav-tabs--gfs a[data-toggle="tab"]').on("click",function(){var hash=$(this).attr("href"),newUrl=url.split("#")[0]+hash;newUrl+="/",history.replaceState(null,null,newUrl)})}(jQuery);;
/**
* DO NOT EDIT THIS FILE.
* See the following change record for more information,
* https://www.drupal.org/node/2815083
...
!function($){Drupal.Ajax&&(Drupal.Ajax.prototype.beforeSend=function(xmlhttprequest,options){if(this.form){options.extraData=options.extraData||{},options.extraData.ajax_iframe_upload="1";var v=$.fieldValue(this.element);null!==v&&(options.extraData[this.element.name]=Drupal.checkPlain(v))}$(this.element).addClass("progress-disabled").attr("disabled",!0),this.progress.element=$('<div class="ajax-progress custom__loader"><div class="ajax-progress-throbber"><div class="throbber"><div class="spinner"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div></div></div></div>'),$(this.progress.element).prependTo($("body"))})}(jQuery);;
//! UpUp
//! version : 1.1.0
...
!function(Drupal,drupalSettings){void 0!==UpUp&&null!==UpUp&&UpUp.start({"content-url":"/themes/custom/gfs/pwa/offline."+drupalSettings.pwa.site+"."+drupalSettings.pwa.language+".html",assets:["/themes/custom/gfs/logo.svg","/themes/custom/gfs/fr-logo.svg"],"service-worker-url":"/upup.sw.min.js"})}(Drupal,drupalSettings);;
/**
* DO NOT EDIT THIS FILE.
* See the following change record for more information,
* https://www.drupal.org/node/2815083
...
(function ($) {
  ...
  Drupal.behaviors.GFSImagePromoTile = {
    attach: function(context, settings) {

      // Bind clicking to the promo tile on AJAX load
      $('.image-promo-tile').once('image-promo-tile-clicker').each(function() {
        if($(this).find('a.button').attr('href') !== undefined) {
